 ...
 document.addEventListener('DOMContentLoaded', function() {
    ...
    function initLightbox() {
        $('.gallery-lightbox').on('click', function(e) {
            ...
            var lightboxImage = $('<img src="' + imageUrl + '" alt="">');
            var closeButton = $('<button class="lightbox-close">&times;</button>');
            ...
            // Встановлення фіксованого скролу для body
            $('body').css('overflow', 'hidden');
            
            // Анімація появи лайтбоксу
            setTimeout(function() {
                lightbox.addClass('active');
            }, 10);
            
            // Закриття при кліку на кнопку чи поза зображенням
